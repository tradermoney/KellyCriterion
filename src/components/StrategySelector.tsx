    ...
    <div className="bg-white dark:bg-slate-700 rounded-md border border-slate-200 dark:border-slate-600 shadow-sm hover:shadow-md transition-all duration-200 p-1">
      <div className="flex items-center justify-between mb-1">
        <div className="flex items-center gap-1.5">
          <div className={`w-5 h-5 rounded-md bg-gradient-to-br ${getColorClasses(strategyIcon?.color || 'orange')} flex items-center justify-center shadow-md`}>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  <span className="w-7 h-7 bg-gradient-to-br from-amber-500 to-orange-600 rounded-md flex items-center justify-center text-white text-sm">{icon.icon}</span>
